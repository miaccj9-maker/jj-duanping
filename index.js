...
async function renderCard() {
    ...
    if (isPolaroid) {
        ...
        let srcH = 64; // 底部白边固定64px(上左右16px的4倍宽横条)，不随高度滑块变化
